<template>
  <div>
    <av-page-header title="基础表单" breadcrumb="true">
      <av-breadcrumb-list slot="breadcrumb"></av-breadcrumb-list>
      <div slot="content">表单页用于向用户收集或验证信息，基础表单常见于数据项较少的表单场景。</div>
    </av-page-header>
    ...
    <a-card :bordered="false">
      ...
      >
        ...
        >
          <a-textarea style="min-height: 32px" placeholder="请输入你的阶段性工作目标" :rows="4"/>
        </a-form-item>
        ...
        <a-form-item v-bind="formItemLayout" fieldDecoratorId="client">
          <span slot="label">
            客户
            <em class="ptional">
              （选填）
